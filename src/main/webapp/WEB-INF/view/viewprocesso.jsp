    ...
    <table class="table table-striped">
        ...
        <c:forEach var="processo" items="${list}">
            <tr>
                ...
                <td><a href="editprocesso/${processo.id}"><i class="material-icons">edit</i> </a> </td>
                <td><a href="deleteprocesso/${processo.id}"><i class="material-icons">delete_outline</i></a></td>
            </tr>
        </c:forEach>
    </table>
    <br/>
